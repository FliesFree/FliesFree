...
def visual_scatto():
    ...
    img = cv.imread('/home/pi/FliesFree/Programma_Prova2_Raspberry/Trappola/%s.jpg' %data_ora.data_ora_attuale())
...
def trova_mosche():
    ...
    img_rgb = cv.imread('/home/pi/FliesFree/Programma_Prova2_Raspberry/Trappola/%s.jpg' %data_ora.data_ora_attuale())
    img_gray = cv.cvtColor(img_rgb, cv.COLOR_BGR2GRAY)
    template1 = cv.imread('/home/pi/FliesFree/Programma_Prova2_Raspberry/Mosche/mosca1.jpg',0)
    template2 = cv.imread('/home/pi/FliesFree/Programma_Prova2_Raspberry/Mosche/mosca2.jpg',0)
   ...
   #-----------------------------------------
    ...
    cv.imwrite('Risultati/result_%s.jpg'%data_ora.data_ora_attuale(),img_rgb)
    print("Ricerca mosche coompletata...")
    print("Mosche trovate:")
    print(num_mosche)
    dongle.invio_dongle("image","0")
    time.sleep(0.2)
    dongle.invio_dongle("onoff",0)
    time.sleep(0.2)
    dongle.invio_dongle("codice",0)
    time.sleep(0.2)
    dongle.invio_dongle("flies",num_mosche)
